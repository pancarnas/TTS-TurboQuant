...
Alternative installs (pip/Makefile, manual per-platform, CPU-only), quick
single-model Makefile checks, Eddie cluster usage and troubleshooting:
...
troubleshooting: [`scripts/gpu/README.md`](scripts/gpu/README.md) and
[`docs/SETUP.md`](docs/SETUP.md).
...
See [`docs/SETUP.md`](docs/SETUP.md#troubleshooting) (torchaudio/CUDA
mismatches, `torchcodec` errors, missing sox).
